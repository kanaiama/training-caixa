				...
				$.each( data, function(k, v) {
					...
					if ( settings.findbyname ) { // by name
						...
						if ( elt.length == 1 ) {
							...
							// modificacao para atualizar o dropkick
							if(elt.is("select") && elt.dropkick && elt.attr("data-dkcacheid")) {
								elt.dropkick("refresh");
							}
							// modificacao para atualizar o dropkick - end
						...
						if ( elt.length == 1 ) {
							elt.val( ( elt.attr("type") == "checkbox" ) ? [v] : v );
							// modificacao para atualizar o dropkick - start
							if(elt.is("select") && elt.dropkick && elt.attr("data-dkcacheid")) {
								elt.dropkick("refresh");
							}
							// modificacao para atualizar o dropkick - end
